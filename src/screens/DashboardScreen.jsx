                    ...
                    <PieChart>
                      <Pie
                        data={[
                          ...
                          { name: 'Half Day', value: summaryMetrics.halfDay || 0, color: '#FBBC04' },
                          ...
                          <tr key={idx} style={{ borderBottom: '1px solid #E8EAED' }}>
                            ...
                            <td style={{ padding: '12px 16px', fontSize: '14px', fontWeight: 500 }}>
                              <span style={{ 
                                ...
                                fontSize: '12px', 
                                fontWeight: '500',
                                backgroundColor: isPresentGreen ? '#E6F4EA' : isLate ? '#FEF3C7' : isPresentWorking ? '#E8F0FE' : isHalfDay ? '#FFF3E0' : (isAbsent ? '#FCE8E6' : '#F1F3F4'),
                                color: isPresentGreen ? '#1E8E3E' : isLate ? '#D97706' : isPresentWorking ? '#1A73E8' : isHalfDay ? '#E65100' : (isAbsent ? '#D93025' : '#5F6368')
                              }}>
                                {statusStr}
                              </span>
                            </td>
